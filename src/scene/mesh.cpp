...
Mesh::Mesh(GLWidget277 *context) : Drawable(context), verts(std::vector<Vertex*>()), halves(std::vector<HalfEdge*>()), faces(std::vector<Face*>())
{}
...
void Mesh::create()
{
    ...
    mp_context->glBufferData(GL_ARRAY_BUFFER, count * sizeof(glm::vec4), normals.data(), GL_STATIC_DRAW);
