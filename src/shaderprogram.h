...
public:
    ...
    int unifBindMatrices; //A handle for the "uniform" array of mat4 that each represent the bind matrix of a joint respectively
    int unifOverallMatrices; //A handle for the "uniform"array of mat4 that each rep the overallTrans mat of a joint respectively
...
public:
    ...
    // Pass the given Projection * View matrix to this shader on the GPU
    void setBindMats(const std::vector<glm::mat4> &w);

    // Pass the given Projection * View matrix to this shader on the GPU
    void setOverallMats(const std::vector<glm::mat4> &w);
